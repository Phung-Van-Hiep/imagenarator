...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    >
      <motion.div className='text-stone-500 inline-flex text-center gap-2 py-1 px-6 bg-white border border-neutral-300 rounded-full'
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 p-2.5 flex 
