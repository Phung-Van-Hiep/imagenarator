            ...
            <div>
                {
                    user ?
                        <div className='flex items-center gap-2 sm:gap-3'>
                            ...
                            <p className='text-xs sm:text-sm font-medium text-gray-600 cursor-pointer'>Creadit left: {credit}</p>
                            </button>
                            ...
                            <div className='relative group'>
                                ...
                                top-0 right-0 z-10 text-black rounded pt-12'>
                                    <ul className='list-none m-0 p-2 bg-blue-100 rounded-md border text-sm'>
