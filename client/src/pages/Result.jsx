...
const Result = () => {
  ...
  return (
    <motion.form
      ...
      viewport={{ once: true }}
      onSubmit={onSubmitHandler} className='flex items-center flex-col justify-center min-h-[90vh]' >
      <div>
      ...
      {!isImageLoaded ?
        <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
          ...
          <button type='submit' className='bg-zinc-900 p-10 sm:px-16 py-3 rounded-full cursor-pointer'>
            Generate
          </button>
        </div>
        :
